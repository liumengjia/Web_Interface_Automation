...
wb = TestExcel('../../data/goods.xlsx','deleteOrder')
...
Test_deleteOrder().test_deleteOrder(path,headers,data)
...
if __name__=='__main__':
    t = Test_deleteOrder()
    t.test_deleteOrder(path,headers,data)
