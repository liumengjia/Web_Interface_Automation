...
# @File : test_getBuyerOrderList.py
...
wb = TestExcel('../../data/goods.xlsx','getBuyerOrderList')
...
Test_getBuyerOrderList().test_getBuyerOrderList(path,headers,data)
...
if __name__=='__main__':
    t = Test_getBuyerOrderList()
    t.test_getBuyerOrderList(path,headers,data)
