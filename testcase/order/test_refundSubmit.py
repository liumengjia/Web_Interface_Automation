...
wb = TestExcel('../../data/goods.xlsx','refundSubmit')
...
Test_refundSubmit().test_refundSubmit(path,headers,data)
...
if __name__=='__main__':
    t = Test_refundSubmit()
    t.test_refundSubmit(path,headers,data)
