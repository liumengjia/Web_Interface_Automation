...
wb = TestExcel('../../data/goods.xlsx','orderCancel')
...
Test_orderCancel().test_orderCancel(path,headers,data)
...
if __name__=='__main__':
    t = Test_orderCancel()
    t.test_orderCancel(path,headers,data)
