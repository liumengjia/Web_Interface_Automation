...
wb = TestExcel('../../data/user.xlsx','thirdPartyLogin')
...
Test_thirdPartyLogin().test_thirdPartyLogin(path,headers,data)
...
if __name__=='__main__':
    t = Test_thirdPartyLogin()
    t.test_thirdPartyLogin(path,headers,data)
