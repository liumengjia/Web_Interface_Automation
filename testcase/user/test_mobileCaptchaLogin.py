...
# @File : test_mobileCaptchaLogin.py
...
wb = TestExcel('../../data/user.xlsx','mobileCaptchaLogin')
...
Test_mobileCaptchaLogin().test_mobileCaptchaLogin(path,headers,data)
...
if __name__=='__main__':
    t = Test_mobileCaptchaLogin()
    t.test_mobileCaptchaLogin(path,headers,data)
