...
Test_accountPwdLogin().test_accountPwdLogin(path,headers,data)
...
if __name__=='__main__':
    t = Test_accountPwdLogin()
    t.test_accountPwdLogin(path,headers,data)
