...
wb = TestExcel('../../data/user.xlsx','modifyCommon')
...
Test_modifyCommon().test_modifyCommon(path,headers,data)
...
if __name__=='__main__':
    t = Test_modifyCommon()
    t.test_modifyCommon(path,headers,data)
