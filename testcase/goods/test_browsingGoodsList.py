...
# @File : test_browsingGoodsList.py
...
wb = TestExcel('../../data/goods.xlsx','browsingGoodsList')
...
Test_browsingGoodsList().test_browsingGoodsList(path,headers,data)
...
if __name__=='__main__':
    t = Test_browsingGoodsList()
    t.test_browsingGoodsList(path,headers,data)
