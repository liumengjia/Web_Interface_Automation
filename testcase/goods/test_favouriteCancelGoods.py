...
# @File : test_favouriteCancelGoods.py
...
wb = TestExcel('../../data/goods.xlsx','favouriteCancelGoods')
...
Test_favouriteCancelGoods().test_favouriteCancelGoods(path,headers,data)
...
if __name__=='__main__':
    t = Test_favouriteCancelGoods()
    t.test_favouriteCancelGoods(path,headers,data)
