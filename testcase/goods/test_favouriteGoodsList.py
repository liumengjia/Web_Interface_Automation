...
# @File : test_favouriteGoodsList.py
...
wb = TestExcel('../../data/goods.xlsx','favouriteGoodsList')
...
Test_favouriteGoodsList().test_favouriteGoodsList(path,headers,data)
...
if __name__=='__main__':
    t = Test_favouriteGoodsList()
    t.test_favouriteGoodsList(path,headers,data)
